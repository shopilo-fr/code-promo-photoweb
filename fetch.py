#!/usr/bin/env python3
"""
Recuperation des codes promo Photoweb depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/photoweb.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/photoweb.fr"
STORE_NAME = "Photoweb"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Photoweb depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-photoweb)"
    }
    try:
